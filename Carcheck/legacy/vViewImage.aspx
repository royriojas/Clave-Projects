<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vViewImage.aspx.cs" Inherits="vViewImage" %>
...
<body>
    ...
    <div>
        <div style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; margin: 5px;
            width: 700px; padding-top: 10px; height: 500px; background-color: #ffffff">
