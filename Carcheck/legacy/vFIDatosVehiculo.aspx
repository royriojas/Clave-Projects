...
<head id="Head1" runat="server">
  <title>Carcheck | Inspección | Datos Vehículo</title>
              ...
              <div class="DataContentRight" style="padding-top: 1px">
                <div class="PanelStyle" style="margin-top: 4px">
                  <div class="PanelEncabezado">
                    ...
                    <img id="Img1" alt="Mostrar / Ocultar Panel" onmouseout="MakeClear(this,0)" onmouseover="MakeClear(this,1);"
                      src="Images/IconHide16Dark.gif" style="margin-top: 3px" title="Mostrar/Ocultar" />
                  </div>
                          ...
                          <tr>
                            ...
                            <td>
                              Sistema de tracción<asp:CompareValidator ID="CompareValidator10" runat="server" ControlToValidate="cbxTraccion"
                                ...
                                ValueToCompare="-1">(*)</asp:CompareValidator></td>
                            <td style="width: 208px">
                              <asp:DropDownList ID="cbxTraccion" runat="server" CssClass="FormTextNoUpperCase" Width="204px"
                                DataSourceID="odsTraccion" DataTextField="traccion" DataValueField="traccionId"
              ...
              <div class="DataContent">
                <div class="DataContentRight" style="height: 24px;">
                  <div style="float: left">
                    <asp:ImageButton ID="btnSave" runat="server" ImageUrl="~/Images/IconSave48Dark.gif"
                      ToolTip="Guardar Datos" CssClass="Button48Left" onmouseout="MakeClear(this,0)"
                      onmouseover="MakeClear(this,1);" OnClick="btnSave_Click" OnClientClick="return protectFormSend();"
                      ValidationGroup="UpdateVehiculo" />
                    <asp:ImageButton ID="btnAnular" runat="server" ImageUrl="~/Images/IconAnul48Dark.jpg"
                      ToolTip="Anular Inspección" CssClass="Button48Left" onmouseout="MakeClear(this,0)"
                      onmouseover="MakeClear(this,1);" />
                  </div>
                  <div style="float: right">
                    <asp:ImageButton ID="btnTerminarInspeccion" runat="server" ImageUrl="~/Images/btnTerminarInspeccion.jpg"
                      ToolTip="Terminar Inspección" onmouseout="MakeClear(this,0)" onmouseover="MakeClear(this,1);"
                      Visible="False" />
                    <asp:ImageButton ID="btnAprobar" runat="server" ImageUrl="~/Images/IconApprove48.jpg"
                      ToolTip="Aprobar Inspección" onmouseout="MakeClear(this,0)" onmouseover="MakeClear(this,1);" />
                    <asp:ImageButton ID="btnDesaprobar" runat="server" ImageUrl="~/Images/IconReject48.jpg"
