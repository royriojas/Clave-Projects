  ...
  <form id="form1" runat="server">
    <div class="Blockable">
      <table id="Data" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
          <td>
            <uc1:ucHeader ID="UcHeader1" runat="server" PageFunctionalityToCheck="INS_LLANTAS_VER" />
              ...
              <div class="DataContentRight" style="padding-top: 1px">
                <div class="PanelStyle" style="margin-top: 4px">
                  <div class="PanelEncabezado">
                    ...
                    <img id="nuevaLlantaImage" alt="Mostrar / Ocultar Panel" src="Images/IconHide16Dark.gif" /></div>
                  <div id="nuevaLlantaData" class="DataTable" style="position: relative">
                    <asp:FormView ID="frmLlanta" runat="server" DataKeyNames="vehiculoId,llantaId" DataSourceID="odsLlanta"
                      ...
                      OnItemInserted="frmLlanta_ItemInserted">
                      <InsertItemTemplate>
                          ...
                          <tr>
                            ...
                            <td class="BorderLeft" style="height: 18px">
                              &nbsp;Medida<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"
                                ...
                                ValidationGroup="NuevaLlantaGroup">(*)</asp:RequiredFieldValidator></td>
                            <td style="height: 18px">
                              <asp:TextBox ID="txtMedidaAro" runat="server" CssClass="FormText ENTERO" Width="50px"
                                TabIndex="430" Text='<%# Bind("medidaAro") %>'></asp:TextBox></td>
                          </tr>
                          <tr>
                            <td style="height: 18px">
                            ...
                            <td align="right" class="BorderRight" style="height: 18px">
                              <asp:TextBox ID="txtCantidad" runat="server" CssClass="FormText ENTERO" Width="50px"
                                TabIndex="455">1</asp:TextBox>&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td align="right" colspan="4" class="BorderLeftRight" style="height: 22px">
                              <asp:Button ID="btnAgregarLlanta" Visible='<%# showBeVisibleBtnAgregarLlanta() %>'
                                runat="server" CssClass="FormButton" Text="Agregar Llanta" OnClientClick=" doNuevaLlantaInsert();return false;"
                                ValidationGroup="NuevaLlantaGroup" />&nbsp;</td>
                          </tr>
                        </table>
                      </InsertItemTemplate>
                    </asp:FormView>
                  ...
                  <asp:GridView ID="llantaGridView" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                      ...
                      <asp:TemplateField HeaderText="Acci&#243;n">
                        ...
                        <ItemTemplate>
                         <asp:ImageButton Visible='<%# shouldBeVisibleEdit() %>' ID="ImageButton1" runat="server" CommandName="Edit" ImageUrl="~/Images/IconEdit.gif" />
                          <asp:ImageButton Visible='<%# shouldBeVisibleDelete() %>'  ID="ImageButton3" runat="server" CommandName="Delete" ImageUrl="~/Images/IconDelete.gif"
