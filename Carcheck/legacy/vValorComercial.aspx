...
<head runat="server">
  <title>Carcheck | Valores Comerciales</title>
      ...
      <table id="Data" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
          <td style="height: 99px">
            <uc1:ucHeader ID="UcHeader1" runat="server" TabActual="valoresComerciales" />
            <div class="DataTop">
                  ...
                  <div class="DataTable">
                    <table border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td colspan="1" style="width: 62px; height: 18px">
                          <asp:ImageButton ID="imgSearch" runat="server" ImageUrl="~/Images/btnsListas/icon_search.jpg" ToolTip="Buscar el valor comercial" ValidationGroup="grpSeach" /></td>
                      </tr>
                      <tr>
                        <td style="height: 18px; width: 136px;">
                          Valor Comercial ($)
