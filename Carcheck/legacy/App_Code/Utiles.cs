...
namespace CCSOL.Utiles
{
  public class Utilidades
  {
    ...
    public static void redirectToUrlWhenIsNull(object UserSessionData, HttpResponse Response, String urlActual)
    {
      if (UserSessionData == null)
      {
        Response.Redirect(String.Format("vLogIn.aspx?urlDest={0}",urlActual));
        Response.End();
      }
    }
