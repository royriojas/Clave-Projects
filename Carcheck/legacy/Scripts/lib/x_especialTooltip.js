...
/*
NOTES:
if you define the className it will override the TagName definition, it means this object will use as trigger elements the elements with that ClassName 
