                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td colspan="2" style="height: 18px">
                        Correspondiente a
                        <asp:CompareValidator ID="rcvCorrespondiente" runat="server" ErrorMessage="Elija la categoría" ControlToValidate="cbxImagenCorrespondencia" Operator="NotEqual" ValidationGroup="btnAdd" ValueToCompare="-1">(*)</asp:CompareValidator></td>
                    </tr>
                    <tr>
                      <td colspan="2">
                        <asp:DropDownList ID="cbxImagenCorrespondencia" runat="server" DataSourceID="odsImagen" DataTextField="imagenCorrespondencia"
                          DataValueField="imagenCorrespondenciaId" Width="281px" CssClass="FormText" AppendDataBoundItems="True">
