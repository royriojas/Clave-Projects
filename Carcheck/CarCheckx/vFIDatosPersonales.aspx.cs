...
public partial class vFIDatosPersonales : System.Web.UI.Page
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    this.anularImageButton.Visible =
      this.guardarImageButton.Visible = GestorInspeccion.couldModify(inspId.ToString());
  ...
  protected void frmvAlertas_ItemUpdating(object sender, FormViewUpdateEventArgs e)
  {
    if (e.NewValues["talertaId"].ToString() == "-1")
    {
      if (e.NewValues.Contains("talertaId")) e.NewValues.Remove("talertaId");
    }
  }
}
