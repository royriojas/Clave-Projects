  ...
  <form id="form1" method="post" runat="server">
    <div>
      <table id="Data" border="0" cellpadding="0" cellspacing="0" align="center">
        <tr>
          <td>
            <uc1:ucHeader ID="UcHeader1" PageFunctionalityToCheck="REPORTE_VER" runat="server"
              TabActual="listaSolicitudes" />
             <div class="DataTop">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td rowspan="5" style="padding-left: 3px" valign="top">
                        <asp:ImageButton ID="btnBuscar" CssClass="MakeClear" runat="server" ImageUrl="~/Images/btnBuscar.gif"
                          AlternateText="Buscar Solicitudes"></asp:ImageButton>
                        <cc2:xWebPanelControl PermissionToCheck="REPORTE_EXPORTAR" ID="XWebPanelControl1"
                          runat="server">
                          <asp:ImageButton CssClass="MakeClear" ID="imgBtnNuevaSolcitud" runat="server" ImageUrl="~/Images/btnExportar.jpg"
                             OnClientClick="alert('to Implement Export');return false;" />
                    ...
                    <tr>
                      ...
                      <td>
                        <asp:DropDownList ID="cbxBroker" runat="server" CssClass="FormText tt_help_info aDropDownWithTitle"
                          Width="140px" TabIndex="9" DataSourceID="odsBroker" DataTextField="persona" DataValueField="personaId"
                    ...
                    <tr>
                      ...
                      <td style="height: 18px">
                        <asp:DropDownList ID="cbxCanal" runat="server" CssClass="FormText tt_help_info aDropDownWithTitle"
                          Width="140px" TabIndex="9" DataSourceID="odsCanal" DataTextField="canal" DataValueField="canalId"
                      ...
                      <td style="height: 18px">
                        <asp:DropDownList ID="cbxTipoRequerimiento" runat="server" CssClass="FormText tt_help_info aDropDownWithTitle"
                          Width="140px" TabIndex="2" DataSourceID="odsTipoRequerimiento" DataTextField="trequerimiento"
                    ...
                    <tr>
                      ...
                      <td>
                        <asp:DropDownList ID="cbxEstado" runat="server" CssClass="FormText tt_help_info aDropDownWithTitle"
                          Width="140px" TabIndex="5" DataSourceID="odsEstado" DataTextField="estadoSolicitud"
                    ...
                    <tr>
                      ...
                      <td>
                        <asp:DropDownList ID="cbxCliente" runat="server" CssClass="FormText tt_help_info aDropDownWithTitle"
                          Width="140px" TabIndex="9" DataSourceID="odsCliente" DataTextField="persona" DataValueField="personaId"
                      ...
                      <td>
                        <asp:DropDownList ID="cbxPrioridad" runat="server" CssClass="FormText tt_help_info aDropDownWithTitle"
                          Width="90px" TabIndex="3" DataSourceID="odsPrioridad" DataTextField="prioridad"
