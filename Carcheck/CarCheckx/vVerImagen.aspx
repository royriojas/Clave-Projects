...
<%@ Register Assembly="CustomPanelWebControl" Namespace="xWebControl" TagPrefix="cc1" %>
...
<body>
  <form id="form1" runat="server">
    <uc1:ucSecurityController ID="UcSecurityController1" PageFunctionalityToCheck="IMAGEN_EDITOR"
      runat="server" />
              ...
              <table id="registroTable" border="0" cellpadding="0" cellspacing="2" style="width: 100%">
                <tr>
                  ...
                  <td style="width: 200px; padding: 1px; height: 365px;" valign="top">
                    <asp:FormView ID="frmImagen" runat="server" DataKeyNames="vehiculoId,imagenId" DataSourceID="odsImagen"
                      DefaultMode="Edit" OnItemUpdating="frmImagen_ItemUpdating">
                      <EditItemTemplate>
                        <div class="DataTable">
                          <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                            ...
                            <tr>
                              <td>
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="FormText" Width="197px"
                                  DataSourceID="odsImagenCorrespondenciaCombo" DataTextField="imagenCorrespondencia"
                                  DataValueField="imagenCorrespondenciaId" SelectedValue='<%# Bind("imagenCorrespondenciaId") %>'>
                    ...
                    <asp:ObjectDataSource ID="odsImagen" runat="server" DeleteMethod="Delete" InsertMethod="Insert"
                      SelectMethod="GetDataBy" TypeName="dsImagesTableAdapters.ImagenTableAdapter" UpdateMethod="Update"
                      OnSelected="odsImagen_Selected">
                      <DeleteParameters>
                ...
                <tr>
                  <td align="right" valign="bottom">
                    <img class="MakeClear" id="zoomImage" src="Images/IconFullImage32.gif" title="Guardar registro"
                      onclick="ImagenCompleta();" style="cursor: pointer; float: left;" />                    
                    <cc1:xwebpanelcontrol id="XWebPanelControl1" runat="server" style="width:75px;float:left;" PermissionToCheck="EDIT_ERASE_IMAGE" ><asp:ImageButton id="imgBtnSave" onclick="imgBtnSave_Click" runat="server" ImageUrl="Images/IconSave32Dark.gif" CssClass="MakeClear"></asp:ImageButton> <asp:ImageButton id="imgBtnDelete" onclick="imgBtnDelete_Click" runat="server" ImageUrl="Images/IconDelete32Dark.gif" OnClientClick="return confirm('Desea eliminar la imagen');" CssClass="MakeClear"></asp:ImageButton></cc1:xwebpanelcontrol>
                    <img class="MakeClear" src="Images/IconExit32Dark.gif"
                        title="Salir" style="cursor: pointer; float: left;" onclick="window.close();" id="IMG1" /></td>
                </tr>
              </table>
            </div>
          </div>
