...
<div id="propiedadPanel" runat="server" class="PanelStyle">
  ...
  <div id="pnlContainerAll" class="DataTable" style="padding: 5px;">
    <table style="width: 490px" border="0" cellpadding="0" cellspacing="0" class="DataTable">
      <tr>
        ...
        <td rowspan="5" style="width: 259px" valign="top" align="left">
          <div id="trace" style="background-color: Red; padding: 5px; display: none; color: White;
            width: auto;">
          </div>
        </td>
      </tr>
    ...
    <br />
    <asp:ImageButton ID="imgBtnAddCaracteristicas" OnClientClick="showMeAllFields();return false;"
      runat="server" ImageUrl="~/Images/btnsListas/btnSaveCaracteristica.jpg" /></div>
</div>
