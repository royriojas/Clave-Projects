function xPopUp(elementId,           //identificador del elemento creado (para poder crear más de un objeto de este tipo			
                ...
                noDrag,              //bool to activate Drag Behaviour
                OnHide               //the OnHide Handler function
)                                    // object prototype
{
  ...
  function collapse()
  {
    ...
    {
      xResizeTo(ele, me.showWidth, me.showHeight);
      var y = xScrollTop()
  ...
  function createElementDiv()
  {
    ...
    popup.innerHTML = "<div id='fen" + elementId + "' class='fenster' style='z-index:400;visibility:hidden;'><div id='fenClose" + elementId
                        + "' class='fenClose' title='Cerrar'>&nbsp;</div><div id='fenMaxBtn" + elementId
                        + "' class='fenMaxBtn' title='Click para Maximizar/Restarurar'>&nbsp;</div><div id='btnMinimize" + elementId
                        + "' class='btnMinimize' title='Click para Minimizar'>&nbsp;</div><div id='fenBar" + elementId
                        + "' class='fenBar' title='Arrastre para mover la ventana'><span style='position:relative;font-weight:bold;left:3px;top:3px;'></span></div><div class='fenContent"
                        + elementId + "'><iframe id='myIframe" + elementId + "' style='' frameborder='0' src=''></iframe></div><div class='status'>&nbsp;</div><div id='fenResBtn"
                        + elementId + "' class='fenResBtn' alt='redimensionar'>&nbsp;</div></div>";
  ...
  */
  ...
  {
    $('fenMaxBtn' + elementId).style.display = "none";
    $('btnMinimize' + elementId).style.display = "none";
    $('fenResBtn' + elementId).style.display = "none";
  }
