...
/* function $
  helper function para ahorrar texto!!!! para no escribir xGetElementById cada vez que necesito hallar un elemento por el Div
RRRM 13/06/2006    
*/
function $(name) {
  var ele;
...
/*
  retorna un arreglo de elementos que tienen el tag name_tag, igualmente estas funciones solo son para ahorrar caracteres a la hora de
  programar
  
  $ y $$ son funciones que alguna vez vi implementadas creo en la libreria Prototype, con las disculpas de quien lo implementó por vez primera
  por no darle el credito por ellas... no son idea mia.
