...
public partial class ucPnlPropiedades : System.Web.UI.UserControl
{
  ...
  {
    this.imgBtnAddCaracteristicas.Visible = GestorInspeccion.couldModify(GestorInspeccion.getInspeccionId(Convert.ToDecimal(Request.QueryString["VehiculoId"])).ToString()) 
                                            && GestorSeguridad.hasPermision(Funcionalidades.FI_CARACTERISTICA_ADD);
  }
